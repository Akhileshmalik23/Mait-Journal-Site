  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/journals/" element={<PrivateRoute isAuthenticated={isAuthenticated} />}>
        ...
        {/* Add id here later*/}
        <Route path='/journals/view/' element={<PrivateRoute isAuthenticated={isAuthenticated} />} >
          <Route path='/journals/view/' element={<JournalData />} />
        </Route>


        <Route path='/usercreatejournal' element={<PrivateRoute isAuthenticated={isAuthenticated} />} >
